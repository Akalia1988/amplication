...
@InputType()
class WisdomorgnizerUpdateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => CustomerUpdateManyWithoutWisdomorgnizersInput,
  })
  @ValidateNested()
  @Type(() => CustomerUpdateManyWithoutWisdomorgnizersInput)
  @IsOptional()
  @Field(() => CustomerUpdateManyWithoutWisdomorgnizersInput, {
    nullable: true,
  })
...
export { WisdomorgnizerUpdateInput };
